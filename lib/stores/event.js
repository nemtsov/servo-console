...
module.exports = function (params) {
  var url, scope;
  if (params.stack) {
    url = regions[params.region].endpoint + '/orgs/' + params.org + '/apps/' + params.app + '/stacks/' + params.stack + '/events';
    scope = params.org + ':' + params.region + ':' + params.app + ':' + params.stack;
  } else if (params.app) {
    url = regions[params.region].endpoint + '/orgs/' + params.org + '/apps/' + params.app + '/events';
    scope = params.org + ':' + params.region + ':' + params.app;
  } else {
    url = regions[params.region].endpoint + '/orgs/' + params.org + '/events';
